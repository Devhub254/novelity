...
$config = array(
    ...
    "key"              => "KkiBL9R2dDwpKiSPK5jBAUPRg8uuWpLrU4oGrZLtDls9dG3O", //Enter your consumer key here
    "secret"           => "leEwrJywO3u8g0QmukNQItFdzoutxK10aAH4EGao73WwUAIxBAFU8GTxMhKkLYiQ", //Enter your consumer secret here
    "username"         => "MyShop",
    "TransactionType"  => "CustomerPayBillOnline",
    "passkey"          => "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919", //Enter your passkey here
    "CallBackURL"      => "https://noveltyk.000webhostapp.com", //When using localhost, Use Ngrok to forward the response to your Localhost
    "AccountReference" => "Novelty ",
    "TransactionDesc"  => "Payment of Products purchased on my store" ,
);
...
if (isset($_POST['phone_number'])) {
    ...
    if($result['ResponseCode'] === "0"){         //STK Push request successful
        ...
        $sql = "INSERT INTO `order`(`ID`, `OrderNo`, `Amount`, `Phone`, `CheckoutRequestID`, `MerchantRequestID`) VALUES ('','".$orderNo."','".$amount."','".$phone."','".$CheckoutRequestID."','".$MerchantRequestID."');";
